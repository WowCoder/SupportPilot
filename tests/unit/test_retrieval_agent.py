...
class TestAgentStates:
    ...
    def test_state_enum(self):
        ...
        from rag.online.pipeline.state import StateEnum

        assert StateEnum.START.value == "start"
        assert StateEnum.QUERY_UNDERSTANDING.value == "query_understanding"
        assert StateEnum.QUERY_DECOMPOSITION.value == "query_decomposition"
        assert StateEnum.TOOL_SELECTION.value == "tool_selection"
        assert StateEnum.TOOL_EXECUTION.value == "tool_execution"
        assert StateEnum.ANSWER_GENERATION.value == "answer_generation"
        assert StateEnum.END.value == "end"

    def test_event_type_enum(self):
        """Test EventType enum"""
        from rag.online.pipeline.state import EventType

        assert EventType.QUERY_RECEIVED.value == "query_received"
        assert EventType.ANSWER_GENERATED.value == "answer_generated"
...
class TestQueryUnderstandingNode:
    ...
    def test_node_initialization(self):
        ...
        from rag.online.pipeline.nodes.query_understanding import QueryUnderstandingNode
...
class TestPlanningNode:
    ...
    def test_node_initialization(self):
        ...
        from rag.online.pipeline.nodes.planning import PlanningNode
...
class TestToolExecutionNode:
    ...
    def test_node_initialization(self):
        ...
        from rag.online.pipeline.nodes.tool_execution import ToolExecutionNode
...
class TestSynthesisNode:
    ...
    def test_node_initialization(self):
        ...
        from rag.online.pipeline.nodes.synthesis import SynthesisNode
