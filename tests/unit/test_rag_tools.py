...
class TestVectorSearchTool:
    ...
    def test_tool_initialization(self):
        ...
        from rag.online.retrievers.dense import VectorSearchTool
    ...
    def test_execute_empty_query(self):
        ...
        from rag.online.retrievers.dense import VectorSearchTool
        from rag.online.retrievers.base import ToolResult
...
class TestBM25Tool:
    ...
    def test_execute_no_documents(self):
        ...
        tool = BM25Tool()
        tool._ensure_index = Mock(return_value=False)
...
class TestMetadataFilterTool:
    ...
    def test_tool_initialization(self):
        ...
        from rag.online.retrievers.filter_tool import MetadataFilterTool
...
class TestEnsembleTool:
    ...
    def test_tool_initialization(self):
        ...
        from rag.online.retrievers.hybrid import EnsembleTool
...
class TestMetricsCollector:
    ...
    def test_singleton_pattern(self):
        ...
        from rag.utils.observability import MetricsCollector
...
class TestContainer:
    ...
    def test_singleton_pattern(self):
        ...
        from rag.utils.container import Container
